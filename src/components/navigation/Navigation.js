      ...
      <ul className="navigation__list">
        <li
          className={`navigation__list-item ${
            navItem === 1 ? "navigation__list-item--active" : ""
          }`}
        >
          <button
            type="button"
        ...
        <li
          className={`navigation__list-item ${
            navItem === 2 ? "navigation__list-item--active" : ""
          }`}
        >
          <button
            type="button"
        ...
        <li
          className={`navigation__list-item ${
            navItem === 3 ? "navigation__list-item--active" : ""
          }`}
        >
          <button
            type="button"
        ...
        <li
          className={`navigation__list-item ${
            navItem === 4 ? "navigation__list-item--active" : ""
          }`}
        >
          <button
            type="button"
