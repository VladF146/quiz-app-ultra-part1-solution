      ...
      <ul className="navigation__list">
        <li
          className={`navigation__list-item ${
            route === "cards" ? "navigation__list-item--active" : ""
          }`}
        >
          <button
            type="button"
        ...
        <li
          className={`navigation__list-item ${
            route === "bookmark" ? "navigation__list-item--active" : ""
          }`}
        >
          <button
            type="button"
            className="navigation__button"
            onClick={() => setRoute("bookmark")}
          >
            <svg className="navigation__icon" viewBox="0 0 24 24">
        ...
        <li
          className={`navigation__list-item ${
            route === "create" ? "navigation__list-item--active" : ""
          }`}
        >
          <button
            type="button"
        ...
        <li
          className={`navigation__list-item ${
            route === "profile" ? "navigation__list-item--active" : ""
          }`}
        >
          <button
            type="button"
